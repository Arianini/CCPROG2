...
-----------------------------------------------------------------------*/
int Initialize(TData territoryNames[])
{
	TData temp;
	int ctr = 0;
...
int main() 
{
    ...
    */
    ...
    num_territories = Initialize(territoryNames); // Initialize territories with data.
...
-----------------------------*/ 
    ...
    printf("Q1: Which location has the highest baseline life expectancy? Display the name of the location and the corresponding life expectancy. [Maximum]\n");
   	printf("\nA1: %s, %.6lf\n",
...
-----------------------------*/
	...
	//TEST CASE #3
	strcpy(param_territories_name[0], "Philippines");
	strcpy(param_territories_name[1], "Prog3Cutie");
	printf("\n---> If parameter_%s and parameter_%s\n", param_territories_name[0], param_territories_name[1]);
